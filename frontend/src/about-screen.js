                ...
                <div className='add-item-form'>
                    ...
                    <div className='about-form-body'>
                        <div className='form-section'>
                            ...
                            <p className='form-text'>We believe in creating joy for others by lifting them up, putting a smile on their faces, and having a little fun in the process! <i className="far fa-laugh-beam"/></p>
                        </div>
                    </div>
                    <hr />
